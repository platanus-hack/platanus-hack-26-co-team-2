# team-2 Platanus Hack 26: Bogotá Project
...
- Juan Camilo Castañeda Mendez ([@pejedev](https://github.com/pejedev))
- Adriántorres ([@binarytreecode](https://github.com/binarytreecode))
- Gabriela Torres Vanegas ([@akkatry](https://github.com/akkatry))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-co-team-2.git
